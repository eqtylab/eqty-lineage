...
class TestShapeDispatch:
    ...
    def test_partial_read_records_identity_without_content(self):
        ...
        events, _ = file_events_from_result(
            {"file": {"filePath": "/repo/a.py", "content": "line 40\n", "startLine": 40,
                      "numLines": 1, "totalLines": 200}},
            tool_use_id="t1",
        )
        assert len(events) == 1
    ...
    def test_partial_read_can_be_excluded(self):
        events, _ = file_events_from_result(
            {"file": {"filePath": "/repo/a.py", "content": "x", "startLine": 40, "numLines": 1,
                      "totalLines": 200}},
            tool_use_id="t1",
    ...
    def test_write_shape_takes_the_post_state_directly(self):
        events, _ = file_events_from_result(
            {"filePath": "/repo/new.py", "content": "fresh\n"}, tool_use_id="t1"
        )
    ...
    def test_unreconstructable_edit_records_the_transition_without_content(self):
        events, _ = file_events_from_result(
            {"filePath": "/repo/a.py", "originalFile": "x = 1\n", "oldString": "nope",
             "newString": "2", "structuredPatch": []},
            tool_use_id="t1",
        )
