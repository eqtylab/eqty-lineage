...
def ingest(
    ...
    triples_path: Optional[Union[str, Path]] = None,
    verbose: bool = False,
    store_blobs: bool = True,
    projection: Optional[Union[str, Path]] = None,
...
def parse_only(transcript: Union[str, Path]) -> Dict[str, Any]:
